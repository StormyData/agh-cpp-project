...
public:
    explicit TimedTextScreen(Context &context, const displayText &displayText, float time,
...
public:
    explicit ButtonExitTextScreen(Context &context, const displayText &displayText, const std::string &button_text,
                                  const std::string &background_name, Screen *next_screen);
